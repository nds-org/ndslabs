...
curl "${HEADERS[@]}" -X PUT --data @services/clowder/clowder.json http://localhost:8083/services/clowder
curl "${HEADERS[@]}" -X PUT --data @services/clowder/mongo.json http://localhost:8083/services/mongo
curl "${HEADERS[@]}" -X PUT --data @services/clowder/elastic.json http://localhost:8083/services/elasticsearch
curl "${HEADERS[@]}" -X PUT --data @services/clowder/image-preview.json http://localhost:8083/services/image-preview
