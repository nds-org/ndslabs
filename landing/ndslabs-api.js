...
angular.module('ndslabs-api', [])
    .factory('ApiServer', ['$q', '$http', '$rootScope', function($q, $http, $rootScope) {
        ...
        var ApiServer = (function() {
             ...
             * @method
             * @name ApiServer#putChange_password
             * @param {} password - Change password object
             * 
             */
            ApiServer.prototype.putChange_password = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
             ...
             * @method
             * @name ApiServer#postReset
             * @param {string} userId - Username or email of the account to reset
             * 
             */
            ApiServer.prototype.postReset = function(parameters) {
                if (parameters === undefined) {
                    parameters = {};
                }
                var deferred = $q.defer();
