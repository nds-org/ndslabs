...
.constant('ProductUrl', 'http://docs.cheesehub.org')

/**
 * Helpful links to include in the landing page / navbar
 */
.value('HelpLinks', [
  { name: "Lesson Overview",       icon: 'fa-info-circle',         url: 'https://docs.cheesehub.org/en/latest/lessons/' },
  { name: "User's Guide",           icon: 'fa-book',               url: 'https://docs.cheesehub.org/en/latest/cheesehub.html' },
  { name: "Developer's Guide",      icon: 'fa-code-fork',          url: 'https://docs.cheesehub.org/en/latest/development/' },
])
...
.constant('BuildDate', new Date('Fri Aug 17 22:01:53 UTC 2018'))
