...
An example of a typical set of UI customizations for the http://www.terraref.ndslabs.org/#/ can be seen [here](https://github.com/nds-org/ndslabs/compare/terra) for .
